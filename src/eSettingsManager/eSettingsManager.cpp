...
void eSettingsManager::Init()
{
    ...
    //{
    //    OVS::OVSSetting& setting = DefaultSettings[i];
    //    if (setting.Type == L"bool")
    //    {
    //        bool value = ini.ReadBoolean(setting.Section, setting.Setting, setting.ValueBool);
    //        setting.ValueBool = value;
    //        Save(&ini, value);
    //    }
    //    else if (setting.Type == L"int")
    //    {
    //        size_t value = ini.ReadInteger(setting.Section, setting.Setting, setting.ValueInt);
    //        setting.ValueInt = value;
    //        Save(&ini, value, true);
    //    }
    //    else if (setting.Type == L"string")
    //    {
    //        std::wstring value = ini.ReadString(setting.Section, setting.Setting, setting.ValueString);
    //        setting.ValueString = value.c_str();
    //        Save(&ini, value);
    //    }
    //}

    //// Debug Settings
    //bEnableConsoleWindow          = ini.ReadBoolean   (L"Settings.Debug",       L"ShowConsole",              true);
    //bPauseOnStart                 = ini.ReadBoolean   (L"Settings.Debug",       L"DebugPause",               false);
    //bDebug                        = ini.ReadBoolean   (L"Settings.Debug",       L"DebugLogging",             false);
    //bAllowNonMVS                  = ini.ReadBoolean   (L"Settings.Debug",       L"NonMVSPatching",           false);
    //                                                                        
    //// Settings                                                             
    //iLogSize                      = ini.ReadInteger   (L"Settings",             L"LogSize",                  50);
    //iLogLevel                     = ini.ReadInteger   (L"Settings",             L"LogLevel",                 0);
    //szModLoader                   = ini.ReadString    (L"Settings",             L"ModLoader",                L"Kernel32.CreateFileW");
    //szAntiCheatEngine             = ini.ReadString    (L"Settings",             L"AntiCheatEngine",          L"User32.EnumChildWindows");
    //szCurlSetOpt                  = ini.ReadString    (L"Settings",             L"CurlSetOpt",               L"libcurl.curl_easy_setopt");
    //szCurlPerform                 = ini.ReadString    (L"Settings",             L"CurlPerform",              L"libcurl.curl_easy_perform");
    //bEnableKeyboardHotkeys        = ini.ReadBoolean   (L"Settings",             L"EnableKeyboardHotkeys",    true);
    //// Keybinds                                                             
    //hkMenu                        = ini.ReadString    (L"Settings.Keybinds",    L"ToggleMenu",               L"F1");
    //                                                                        
    //// Patches                                                              
    //bSunsetDate                   = ini.ReadBoolean   (L"Patches",              L"SunsetDate",               true);
    //bDisableSignatureCheck        = ini.ReadBoolean   (L"Patches",              L"PakLoader",                true);
    //// Features                                                             
    //bHookUE                       = ini.ReadBoolean   (L"Features",             L"HookUE",                   true);
    //bDialog                       = ini.ReadBoolean   (L"Features",             L"Dialog",                   true);
    //bNotifs                       = ini.ReadBoolean   (L"Features",             L"Notifications",            true);
    //                                                                        
    //// Patterns                                                             
    //pSigCheck                     = ini.ReadString    (L"Patterns",             L"SigCheck",                 OVS::Patterns::SigCheck);
    //pEndpointLoader               = ini.ReadString    (L"Patterns",             L"EndpointLoader",           OVS::Patterns::EndpointLoader);
    //pProdEndpointLoader           = ini.ReadString    (L"Patterns",             L"ProdEndpointLoader",       OVS::Patterns::ProdEndpointLoader);
    //pSunsetDate                   = ini.ReadString    (L"Patterns",             L"SunsetDate",               OVS::Patterns::SunsetDate);
    //// Features                                                             
    //pFText                        = ini.ReadString    (L"Patterns.UE",          L"FText",                    OVS::Patterns::FText);
    //pCFName                       = ini.ReadString    (L"Patterns.UE",          L"CFName",                   OVS::Patterns::CFName);
    //pWCFname                      = ini.ReadString    (L"Patterns.UE",          L"WCFName",                  OVS::Patterns::WCFName);
    //pDialog                       = ini.ReadString    (L"Patterns.MVS",         L"Dialog",                   OVS::Patterns::Dialog);
    //pDialogParams                 = ini.ReadString    (L"Patterns.MVS",         L"DialogParams",             OVS::Patterns::DialogParams);
    //pDialogCallback               = ini.ReadString    (L"Patterns.MVS",         L"DialogCallback",           OVS::Patterns::DialogCallback);
    //pQuitGameCallback             = ini.ReadString    (L"Patterns.MVS",         L"QuitGameCallback",         OVS::Patterns::QuitGameCallback);
    //pFighterInstance              = ini.ReadString    (L"Patterns.MVS",         L"FighterInstance",          OVS::Patterns::FighterInstance);
    //pNotifs                       = ini.ReadString    (L"Patterns.MVS",         L"Notifications",            OVS::Patterns::Notifications);
    //

    //// Private Server

    //szServerUrl                   = ini.ReadString     (L"Server.Game",         L"ServerUrl",                OVS::ServerUrl);
    //szProdServerUrl               = ini.ReadString     (L"Server.Prod",         L"ServerUrl",                OVS::ProdServerUrl);
    //bEnableServerProxy            = ini.ReadBoolean    (L"Server.Game",         L"Enabled",                  true);
    //bEnableProdServerProxy        = ini.ReadBoolean    (L"Server.Prod",         L"Enabled",                  true);
